...
;(function($){
	...
	$.skygqbox = function(elements,s){
		...
		//弹框的显示初始化
		//var WRAP = '<div id="skygqOverlay"></div><div class="wrap_out" id="wrapOut"><div class="wrap_in" id="wrapIn"><div class="wrap_body" id="wrapBody"></div></div></div>';
		var WRAP = '<div id="skygqOverlay"></div><div class="wrap_out" id="wrapOut"><div class="wrap_in" id="wrapIn"><div class="wrap_body" id="wrapBody"></div></div></div>';
		$("body").append(WRAP);
...
//==========================================
					...
					$.o.out.css({marginTop: '-65px'});	//位置计算错误，设置为指定
//==========================================
				}
				break;
			case "left_top":
